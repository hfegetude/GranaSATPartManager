    ...
    if(code){
        ...
        new ClipboardJS('#copyExcel', {
            text: function(trigger) {
                ...
                var img = document.querySelector("#mainImage").src
    ...
    if(code){
        ...
        new ClipboardJS('#copyExcel', {
            text: function(trigger) {
                ...
                var datasheet = document.querySelector("#product > div.mainPdpWrapper > section:nth-child(4) > div > div.proDescAndReview > div.productDescription.packaging > dl > div:nth-child(5) > dd > a").href
                var img = document.querySelector("#productMainImage").src
    ...
    if(code){
        ...
        new ClipboardJS('#copyExcel', {
            text: function(trigger) {
                ...
                var datasheet = document.querySelector("#main-content > section > div > div.Pdp-layout-top.Content > div > div.col-md-7 > div.Product-Summary.row > div.u-phablet-up-show.col-xs-6.col-md-4 > div > ul > li > a").href
                var img = document.querySelector("#main-content > section > div > div.Pdp-layout-top.Content > div > div.col-md-7 > div.Product-Summary.row > div.col-xs-6.col-md-8 > div > div:nth-child(1) > div > div > img").src
    ...
    if(code){
        ...
        new ClipboardJS('#copyExcel', {
            text: function(trigger) {
                ...
                var datasheet = document.querySelector("#pdp_content > div.product-details-overview > div.product-details-documents-media.product-details-section > table > tbody > tr:nth-child(1) > td > span > a").href
                var img= document.querySelector("#product-photo > div.product-photo-wrapper > a > img").src
    ...
    if(code){
        ...
        new ClipboardJS('#copyExcel', {
            text: function(trigger) {
                ...
                var datasheet= document.querySelector("#WC_TechnicalSpecification_Image_2_").href
                var img = document.querySelector("#slideshow > div > img").src
